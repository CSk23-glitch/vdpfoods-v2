...
target_file = r"d:\videepthaFoods\VideepthaWeb2\Videeptawebsite-frontend\website-frontend\src\pages\Home.tsx"
...
export default function Home() {
    ...
    return (
        <div className="bg-[var(--color-bg)] text-[var(--color-text)] overflow-x-hidden">
            ...
            <section className="relative min-h-[100svh] overflow-hidden flex items-center justify-center pt-20">
                ...
                >
                    ...
                    <motion.div variants={fadeUpVariant} className="flex gap-4 justify-center items-center flex-wrap">
                        <Link to="/products" className="px-8 py-4 bg-[var(--color-primary)] text-[var(--color-bg)] rounded-full font-bold tracking-widest uppercase text-sm hover:scale-105 transition-transform shadow-xl">
                            The Taste of Truth
                        </Link>
                    </motion.div>
                </motion.div>
            ...
            <section id="philosophy" className="py-24 px-6 bg-[var(--color-surface)]">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="bg-[var(--color-bg)] rounded-[2rem] border border-[var(--color-border)] shadow-2xl overflow-hidden"
                    >
            ...
            {/* About Us Section */}
            <section id="about-us" className="py-24 px-6 bg-[var(--color-bg)]">
                    ...
                    >
                        <motion.div variants={fadeUpVariant}>
                            ...
                            <div className="bg-[var(--color-surface)] p-10 md:p-14 rounded-[2.5rem] shadow-2xl border border-[var(--color-border)]">
                                <h3 className="text-4xl text-[var(--color-secondary)] mb-6 font-serif font-black">Food!!!!!</h3>
                    ...
                    >
                        ...
                        {[1, 2, 3].map((set) => (
                            <React.Fragment key={set}>
                                <div className="w-[320px] bg-[var(--color-panel)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-primary)] transition-colors">
                                ...
                                <div className="w-[320px] bg-[var(--color-panel)] border border-[var(--color-border)] p-8 rounded-3xl shrink-0 hover:border-[var(--color-secondary)] transition-colors">
            ...
            <section className="bg-[var(--color-bg)] overflow-hidden border-t border-[var(--color-border)]">
                <div className="grid grid-cols-1 md:grid-cols-2 relative z-10 w-full min-h-[400px]">
                    ...
                    >
                        ...
                        <Link to="/products" className="px-8 py-4 bg-[var(--color-secondary)] text-[var(--color-bg)] rounded-full font-black uppercase tracking-widest text-sm hover:scale-105 transition-transform flex items-center justify-center self-start shadow-xl">
